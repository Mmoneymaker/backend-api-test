    ...
    async def execute(self, input_text: str) -> str:
        ...
        try:
            ...
            while True:
                ...
                # step_info包含了第一个要进行的step的内容和类型，比如是search还是什么
                ...
                #step = "1. [SEARCH] Search for information about Python"
                #{"text": "1. [SEARCH] Search for information about Python", "type": "search"}
            ...
            for i, step in enumerate(steps):
                if i >= len(step_statuses):
                    ...
                    status = step_statuses[i]
                          #active_statuses包含not_started和in_progress
